...
# generated copy, and the web tool on colorpickfromimage.com carries another.
# This script refreshes both; test/sync.test.mjs fails if a copy and the
# source ever drift apart, so the duplication cannot rot silently.
#
set -euo pipefail
